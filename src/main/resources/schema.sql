...
CREATE TABLE SPF_EQUIPE (
    CNPJ VARCHAR(14),
    NOME VARCHAR(255) NOT NULL,
    NUMERO_INTEGRANTES INT CHECK (NUMERO_INTEGRANTES > 0),
...
CREATE TABLE SPF_ATLETA (
    ...
    GENERO CHAR(1),
    AGENCIA_CNPJ VARCHAR(14),
    EQUIPE_CNPJ VARCHAR(14),
...
CREATE TABLE SPF_SEGUIDOR (
    NOME_USUARIO_SEGUIDOR VARCHAR(255),
    NOME_USUARIO_SEGUIDO VARCHAR(255),
...
CREATE TABLE SPF_PATROCINADOR (
    CNPJ VARCHAR(14),
    ESFERA_DE_PODER VARCHAR(255) NOT NULL,
...
CREATE TABLE SPF_SERVICO_OFERECIDO (
    PATROCINIO_NUM_CONTRATO VARCHAR(20),
    SERVICO VARCHAR(255),
    CONSTRAINT PK_SPF_SERVICOS_OFERECIDOS PRIMARY KEY (PATROCINIO_NUM_CONTRATO, SERVICO),
...
CREATE TABLE SPF_EVENTO (
    ...
    NUMERO_LOCAL INT CHECK (NUMERO_LOCAL > 0) NOT NULL,
...
CREATE TABLE SPF_EXPERIENCIA (
    ...
    CONSTRAINT PK_SPF_EXPERIENCIA PRIMARY KEY (NOME_USUARIO, DESCRICAO),
    CONSTRAINT FK_SPF_ATLETA_SPF_EXPERIENCIA FOREIGN KEY (NOME_USUARIO) REFERENCES SPF_ATLETA(NOME_USUARIO)
);
